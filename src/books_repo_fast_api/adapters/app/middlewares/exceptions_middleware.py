...
from books_repo_fast_api.adapters.app.middlewares.base_middleware import BaseMiddleware
from books_repo_fast_api.domain.exceptions import NotFoundError
